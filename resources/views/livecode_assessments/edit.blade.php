...
@section('content')
        ...
        <div class="">
            <div class="card h-full shadow">
                <div class="border-b border-gray-300 px-5 py-4 flex items-center w-full justify-between">
                    <div>
                        <h4 class="font-semibold text-base">Edit Penilaian Livecode untuk {{ $user->name }}</h4>
                    </div>
                </div>

                <div class="container mx-auto py-8 px-5">
                    <form action="{{ route('livecode_assessments.update', $assessment->id) }}" method="POST">
                        @csrf
                        @method('PUT')
    ...
    <div class="offcanvas translate-x-full fixed top-0 w-full right-0 border-l border-gray-300 transition-all duration-300 transform h-full invisible bg-white z-50 max-w-xl"
        ...
        <div class="tab-content py-6 h-[800px]" id="offcanvas-tabContent">
            ...
            <div class="tab-pane fade h-[800px]" id="htmlContent" role="tabpanel" aria-labelledby="tab-html" tabindex="0">
                <textarea id="htmlEditor" class="w-full h-[800px] *:h-[800px]"></textarea>
            </div>

            <div class="tab-pane fade h-[800px]" id="cssContent" role="tabpanel" aria-labelledby="tab-css" tabindex="0">
                <textarea id="cssEditor" class="w-full h-[800px] *:h-[800px]"></textarea>
            </div>

            <div class="tab-pane fade h-[800px]" id="jsContent" role="tabpanel" aria-labelledby="tab-js" tabindex="0">
